...
<html lang="en-US">
	<head>
		...
		<link rel="stylesheet" href="{{URL::asset('assetsYelo/assetscss/style.css')}}">
                ...
                <nav id="main-navbar" class="navbar navbar-default navbar-fixed-top" role="navigation"> <!-- Classes: navbar-default, navbar-inverse, navbar-fixed-top, navbar-fixed-bottom, navbar-transparent. Note: If you use non-transparent navbar, set "height: 98px;" to #header -->
                  ...
                  <div class="container">
                    ...
                    <div class="navbar-header">
                      ...
                      <a class="navbar-brand page-scroll" href="{{URL::asset('assetsYelo/index.html')}}">Yeloixtlahuaca</a>
                    </div>

                    <!-- Collect the nav links, forms, and other content for toggling -->
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
                            <li><a class="page-scroll" href="{{URL::asset('assetsYelo/body')}}">Inicio</a></li>
                            <li><a class="page-scroll" href="{{URL::asset('assetsYelo/#about-section')}}">Acerca de</a></li>
                            <li><a class="page-scroll" href="{{URL::asset('assetsYelo/#mission-section')}}">Mision, Vision y Objetivo</a></li>
                            <li><a class="page-scroll" href="{{URL::asset('assetYelo/#contact-section')}}">Contacto</a></li>
                        </ul>
                    </div><!-- /.navbar-collapse -->
                  </div><!-- /.container -->
                </nav>
